...
- [.opencode/opencode.json](.opencode/opencode.json) — OpenCode project config (loads project-rules, ui-ux-pro-max, prompt-rules, holistic-audit-refactor skills)
...
- [.opencode/skills/prompt-rules/SKILL.md](.opencode/skills/prompt-rules/SKILL.md) — Prompt generation & execution management skill (2 rules, Phase 0 validation, session system assignment, Phase 1 filtering — v1.1 Build: 002)
...
- [.opencode/skills/holistic-audit-refactor/SKILL.md](.opencode/skills/holistic-audit-refactor/SKILL.md) — Full-stack code audit, bug detection, security hardening & refactoring (2 rules — v1.0 Build: 001)
- [docs/prompts/INDEX.md](docs/prompts/INDEX.md) — Prompts index (generated by prompt-rules)
- [docs/prompts/templates/shared-prompt-template.md](docs/prompts/templates/shared-prompt-template.md) — Reusable prompt template
