...
- [ ] `pnpm --filter @sms-monitor/backend typecheck` — 0 errors
- [ ] `pnpm --filter @sms-monitor/backend build` — clean
- [ ] `pnpm --filter @sms-monitor/backend test:e2e` — all tests pass
- [ ] Android builds without errors
- [ ] Web builds without errors
- [ ] Manual smoke: create workspace → claim device → verify forwarding
